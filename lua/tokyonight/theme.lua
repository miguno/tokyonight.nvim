...
function M.setup()
  ...
  theme.highlights = {
    ...
    IncSearch = { bg = c.magenta4, fg = c.black }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
    ...
    Type = { fg = c.blue3 }, -- (preferred) int, long, char, etc.
    ...
    ["@lsp.typemod.type.defaultLibrary"] = { fg = c.blue3 },
    ["@lsp.typemod.typeAlias.defaultLibrary"] = { fg = c.blue3 },
